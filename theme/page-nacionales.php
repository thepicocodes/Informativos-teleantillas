...
<div class="w-full max-w-[1350px] grid grid-cols-1 xl:grid-cols-[160px_1fr_160px] gap-y-5 gap-x-5 justify-items-center mt-8 mx-auto px-5">
  ...
  <div class="order-2 w-full max-w-5xl">
    ...
    <!--  -->
    <section class="mt-10">
      <h5 class="text-m-b lg:text-h5 text-orange-InfTeleantillasDark">Nacionales</h5>
    ...
    <section class="mt-10">
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-5">
        ...
        <div class="rounded-lg w-full h-full max-h-[300px] md:col-span-2 lg:col-auto p-3 bg-[#F1F3F7]">
          <div class="w-full h-full bg-[#D6CCFF]"></div>
        </div>
      </div>


      <div class="mt-5 grid lg:grid-cols-[1fr_300px] gap-x-5 gap-y-5">
        ...
        <div class="rounded-lg w-full h-full p-3 bg-[#F1F3F7]">
          <div class="w-full h-full bg-[#D6CCFF]"></div>
        </div>
    ...
    <section class="mt-10">
      <div class="h-full mt-5 grid grid-cols-1 md:grid-cols-[1fr_300px] gap-x-8 gap-y-5">

        <a href="#" class="relative block w-full h-[460px] bg-white">
          <article class="relative w-full h-[460px] bg-gradient-to-t from-overlay-100 to-overlay-0">
            <img src="<?php echo get_template_directory_uri(); ?>/images/img-01.png" alt="" class="absolute top-0 left-0 w-full h-full ">
            <div class="rounded-lg h-full relative z-[1] p-5 lg:p-10 flex flex-col justify-end text-white bg-gradient-to-t from-overlay-100 to-overlay-0">
              <p class="mt-2 text-m-b lg:text-h4">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
              <div class="mt-2 text-xs text-lightBlue-100">
        ...
        <div class="flex flex-col gap-5">
          ...
          <a href="#" class="relative block w-full h-[300px] bg-white">
            <article class="relative w-full h-[300px] bg-gradient-to-t from-overlay-100 to-overlay-0">
              <img src="<?php echo get_template_directory_uri(); ?>/images/img-01.png" alt="" class="absolute top-0 left-0 w-full h-full ">
              <div class="rounded-lg h-full relative z-[1] p-5 lg:p-5 flex flex-col justify-end text-white bg-gradient-to-t from-overlay-100 to-overlay-0">
                <p class="mt-2 text-m-b lg:text-m-b">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
                <div class="mt-2 text-xs text-lightBlue-100">
                  Victor Santana • 08/04/2024 14:51
                </div>
              </div>
          ...
          <div>
            <h3 class="text-m-b">Siguenos</h3>
            <ul class="mt-2 flex flex-wrap items-center gap-5">
              <li>
                <a href="" class="">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-8 fill-orange-InfTeleantillasDark" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              ...
              <li>
                <a href="">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-8 fill-orange-InfTeleantillasDark" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              ...
              <li>
                <a href="">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-8 fill-orange-InfTeleantillasDark" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
      ...
      <div class="mt-10">
        ...
        <div class="mt-5 grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-5">
