  ...
  <div class="order-2 w-full max-w-5xl">
    ...
    <div class="rounded-2xl w-full my-8 py-8 px-10 shadow-md">
      ...
      <form action="#" method="POST" class="mt-5">
        ...
        <div class="mt-10">
          <button type="submit" class="rounded-lg inline-block bg-orange-laNota px-8 py-4 text-center text-m-b lg:text-xl-b text-white bg-orange-InfTeleantillasDark drop-shadow-lg">Enviar</button>
        </div>
      </form>
    </div>
  </div>
