...
<div class="w-full max-w-[1354px] grid grid-cols-1 xl:grid-cols-[160px_1fr_160px] justify-items-center gap-y-5 gap-x-5 mt-24 mx-auto px-5">
  ...
  <div class="order-2 w-full max-w-5xl">
    ...
    <div class="rounded-2xl w-full my-8 py-8 px-10 shadow-md">
      <div class="">
        <h4 class="text-xl-b lg:text-h4 text-orange-InfTeleantillasDark font-bold">Hola, ¿deseas contactarnos?</h4>
        <p class="">Los campos marcados con (<span class="text-red-500">*</span>) son obligatorios</p>
      </div>
      <form action="#" method="POST" class="mt-5">
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            <label for="first-name" class="block text-body text-blue-900">Nombre:</label>
            <div class="mt-2.5">
          ...
          <div>
            <label for="last-name" class="block text-body text-blue-900">Apellido:</label>
            <div class="mt-2.5">
          ...
          <div class="sm:col-span-2">
            <label for="email" class="block text-body text-blue-900">Correo:</label>
            <div class="mt-2.5">
          ...
          <div class="sm:col-span-2">
            <label for="message" class="block text-body text-blue-900">Message</label>
            <div class="mt-2.5">
        ...
        <div class="mt-10">
          <button type="submit" class="rounded-lg inline-flex items-center gap-x-2 px-8 py-4 text-center text-m-b lg:text-xl-b text-white drop-shadow-lg bg-orange-InfTeleantillasDark">
            Enviar
