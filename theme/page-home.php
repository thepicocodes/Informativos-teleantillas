    ...
    <section>
      ...
      <div class="mt-5 grid grid-cols-1 md:grid-cols-[1fr_300px] gap-5">
        ...
        <div class="flex flex-col gap-5">
          <a href="">
            <img src="<?php echo get_template_directory_uri(); ?>/images/img-ta-live.png" alt="" class="w-full h-[115px] object-contain lg:object-none">
          </a>

          <a href="/" class="mid-block">
            <article class="rounded-md border border-gray-100 w-full grid grid-cols-[60%_40%] overflow-hidden min-h-[140px] max-h-[140px]">
              <div class="content">
