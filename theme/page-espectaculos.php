...
/**
 *
 * Template Name: Espectaculos Page
 *
...
<div class="w-full max-w-[1350px] grid grid-cols-1 xl:grid-cols-[160px_1fr_160px] gap-y-5 gap-x-5 justify-items-center mt-8 mx-auto px-5">
  ...
  <div class="order-2 w-full max-w-5xl">
    ...
    <!--  -->
    <section class="mt-10">
      <h5 class="text-m-b lg:text-h5 text-orange-InfTeleantillasDark">Espectaculos</h5>
    ...
    <div class="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-8">
      ...
      <div class="flex flex-col">
        <div class="rounded-md w-full h-[304px] p-4 bg-[#F1F3F7]">
          <div class="w-full h-full bg-[#D6CCFF]"></div>
        </div>
        <!-- ad -->
        <div class="rounded-md w-full h-full h-[600px] mt-5 p-4 bg-[#F1F3F7]">
          <div class="w-full h-full bg-[#D6CCFF]"></div>
        </div>
        <!--  -->
      </div>
