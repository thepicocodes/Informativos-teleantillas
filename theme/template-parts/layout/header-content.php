...
<header class="border-b border-b-[#FFEFDA] py-4">
	<div class="w-full max-w-screen-xl mx-auto px-5 flex flex-row items-center justify-between lg:justify-between gap-x-2">
		<a href="" class="block w-full max-w-[184px]">
			<img src="<?php echo get_template_directory_uri(); ?>/images/informativos-ta-logo-transparente-02.png" alt="Logo informativos teleantillas" class="rounded-lg h-full">
		</a>
		<nav id="navigation" class="hidden lg:flex w-full h-screen lg:h-auto flex-col lg:flex-row items-center lg:justify-center gap-x-1 absolute lg:static left-0 bg-white lg:bg-inherit z-50 <?php echo is_user_logged_in() ? 'top-10' : 'top-0' ?>">
			<ul id="nav-links" class="w-full h-screen md:h-auto md:w-fit flex flex-col gap-y-5 lg:flex-row lg:items-center gap-x-1 px-5 lg:px-0 text-orange-InfTeleantillas text-sm font-bold">
		...
		<div class="flex flex-row items-center gap-x-5">
			...
			<ul class="relative flex flex-row items-center gap-x-4">
				...
				<a href="#" id="search-toggler" class="cursor-pointer">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-4 fill-orange-InfTeleantillasDark" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
						<path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" />
					</svg>
				</a>
				<a href="#" id="search-close" class="hidden">
					<span class="cursor-pointer rounded-full w-6 h-6 flex items-center justify-center">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 fill-orange-InfTeleantillasDark" viewBox="0 0 384 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
							<path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" />
						</svg>
					</span>
				</a>
				<li>
					<a href="" class="px-2">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-orange-InfTeleantillasDark" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
							<path d="M64 112c-8.8 0-16 7.2-16 16v22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1V128c0-8.8-7.2-16-16-16H64zM48 212.2V384c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V212.2L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z" />
						</svg>
					</a>
				</li>
				<a href="#" id="navbar-toggler" class="block lg:hidden">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-orange-InfTeleantillasDark" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
